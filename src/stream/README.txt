...
In this example, stream.py is streaming to localhost which is not useful. 
    python3 stream.py --headless --width=1080 --height=720 (other options are possible https://github.com/dusty-nv/jetson-inference)
You should change HOST to your computer ip in stream.py and launch get_stream.py on your computer (or another jetson) to get the video stream.
